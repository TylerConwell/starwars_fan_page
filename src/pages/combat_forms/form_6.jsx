...
import form_6_background from '../../assets/endor.png';

const Form6 = () => {
  return (
    /* We use page-hero to get the full-screen background and centering */
    <div className="page-hero" style={{ backgroundImage: `url(${form_6_background})` }}>
    
      <div className="content">
        <h1 style={{ color: '#ffe81f' }}>FORM VI: Djem So</h1>
